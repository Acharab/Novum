        ...
        <div className="flex flex-wrap items-center w-full lg:w-1/2">
          <div className="flex flex-col w-full lg:pl-1 md:justify-center md:items-center lg:mt-4">
            ...
            {data.Advantages.map((advantage, id) => (
              <div key={id}>
                <h2 className="max-w-xl justify-center flex gap-5  mt-3 text-xl font-bold leading-relaxed pb-5 tracking-tight text-gray-000 lg:leading-tight lg:text-xl">
                  <NextImage media={advantage.Image} className="text-3xl" />{" "}
                  {advantage.Title}
                </h2>
                <p className="max-w-lg py-5  leading-normal text-gray-400 text-base  text-center  dark:text-gray-300">
