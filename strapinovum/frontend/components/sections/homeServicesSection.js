                ...
                <div>
                  ...
                  <div className="md:pt-3 pt-2">
                    ...
                    {card.Buttons.map((button) => (
                      <CustomLink className="w-max" link={button}>
          ...
          <Link href="/diensten">
            <div className="flex-auto  flex justify-center items-center lg:items-center mb-32 pt-20  sm:flex">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="px-8 mr-10 py-4 sm:items-center items-stretch  text-xl font-medium text-center ease-in duration-300 hover:bg-orange-500 hover:text-white text-orange-500 border-2 border-orange-500 rounded  "
              >
              ...
              <div className="flex flex-wrap justify-center gap-5 md:justify-around">
                {data.companys.map((company) => (
                  <div className="pt-2 text-gray-400 dark:text-gray-400">
                    <NextImage media={company.companys} width={75} height={75} className="border-2 border-slate-100 hover:border-slate-300" />
                  </div>
                ))}
              </div>
            </div>
